 ...
 * @version $Id: WarMojo.java 1498124 2013-06-30 14:04:20Z rfscholte $
 */
    ...
    extends AbstractWarMojo
{
    ...
    /**
     * init copy file process config
     * @since 2.1-alpha-2
     */
    @Parameter(defaultValue="${basedir}/src/main/resources/package.conf")
    private String packageConf;
    ...
    {
    	Constants.put(Constants.WAR_NAME, warName);
    	Constants.put(Constants.OUTPUT_DIRECTORY,outputDirectory);
    	Constants.put(Constants.BASE_DIR	,basedir);
    	Constants.init(packageConf);
